...
# Comments removed since its a continuation of naive_bayes.py
# Go back to previous lesson to learn more about it
...
print("naive baye: ", accuracy_score(y_pred_nb, y_test))

# The last algorithm we'll test is called linear support vector machine, or SVM for short.
# The main idea behind this algorithm is to find the best possible boundary that separates the classes
# SVM always tries to find the best possible straight separation between classes
# specially efeective for text, so they're a strong choice for sentiment analysis
