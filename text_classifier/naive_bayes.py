...
# Comments removed since its a continuation of logistic_regression.py
...
# We'll try to improve the low accuracy score from the previous lesson by using Naive Bayes
# A simple classification algorithm that works using probabilities
